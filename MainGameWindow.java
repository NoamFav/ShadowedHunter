...
public class MainGameWindow extends JFrame {
    ...
    private MainGameWindow() {
        ...
        BackgroundMusic.play("Resources/ThemMusic.mp3",20);
    ...
    public static class GamePanel extends JPanel {
        ...
        public GamePanel() {
            ...
            cheatSheet = new ImageIcon(Objects.requireNonNull(getClass().getResource("Resources/CheatSheet.png"))).getImage();
        ...
        private void drawInventory(Graphics2D g2d) {
            ...
            key = new ImageIcon(Objects.requireNonNull(getClass().getResource("Resources/inventoryItems/key.png"))).getImage();
            health = new ImageIcon(Objects.requireNonNull(getClass().getResource("Resources/inventoryItems/healthPotion.png"))).getImage();
            sword = new ImageIcon(Objects.requireNonNull(getClass().getResource("Resources/inventoryItems/Sword.png"))).getImage();
            shield = new ImageIcon(Objects.requireNonNull(getClass().getResource("Resources/inventoryItems/Shield.png"))).getImage();
