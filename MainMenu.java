...
public class MainMenu extends JFrame {
    ...
    public MainMenu() {
        backgroundImage = loadImage("Resources/ground.jpg");
        titleImage = loadImage("Resources/Title.png");
        ...
        bgMusic.play("Resources/VoidBgMusic.mp3",20f);
    ...
    private class ImagePanel extends JPanel {
        ...
        public ImagePanel() {
            ...
            rightButton.addActionListener(e -> {
                bgMusic.stopMusic();
                MainGameWindow.getInstance();
                SaveLoadSystem.loadGame("Save/Save.txt");
                MainMenu.this.dispose();
            });
